...
CMD ./spark-2.4.6-bin-hadoop2.7/bin/spark-submit --verbose --deploy-mode client --master local --driver-memory 1g --class com.learning.analyzer.main.App /opt/application/access-log-analyzer_2.11-1.0.0.jar 4 "/opt/tmp" "ftp://ita.ee.lbl.gov/traces/NASA_access_log_Jul95.gz"
